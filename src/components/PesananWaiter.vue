          ...
          <template v-slot:[`item.actions`]="{ item }">
            <v-btn
              ...
              @click="
                ...
                editItem(item);
              "
              v-show="item.status != 'Ready' &&  item.status != 'Not Ready' "
              color="#F9DB6D"
            ...
            <v-btn
              ...
              @click="
                ...
                editItem(item);
              "
              v-show="item.status != 'Served' && item.status != 'Not Ready'"
              color="#F9DB6D"
              style="margin-left: 10px"
            >
              Served
...
export default {
  ...
  methods: {
    ...
    updateStatusPesanan() {
      ...
      else if (this.jenisUpdate == "Served")
        this.formData.append("status", "Served");
