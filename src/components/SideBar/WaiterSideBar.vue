...
export default {
  ...
  data() {
    return {
      ...
      //item di sidebar
      items: [
        { title: "Customer", to: "/waiter/customer", icon: "mdi-account" },
        { title: "Menu", to: "/waiter/menu", icon: "mdi-food" },
        { title: "Meja", to: "/waiter/meja", icon: "mdi-table-furniture" },
        {
          title: "Reservasi",
          to: "/waiter/reservasi",
          icon: "mdi-clipboard-list",
        },
        { title: "Pesanan", to: "/waiter/pesanan", icon: "mdi-playlist-check" },
      ],
    };
  },
  methods: {
