...
export default {
  ...
  data() {
    return {
      ...
      //item di sidebar
      items: [
        { title: "Customer", to: "/cashier/customer", icon: "mdi-account" },
        { title: "Menu", to: "/cashier/menu", icon: "mdi-food" },
        { title: "Meja", to: "/cashier/meja", icon: "mdi-table-furniture" },
        { title: "Pesanan", to: "/cashier/pesanan", icon: "mdi-playlist-check" },
        { title: "Reservasi", to: "/cashier/reservasi", icon: "mdi-clipboard-list" },
        { title: "Transaksi", to: "/cashier/transaksi", icon: "mdi-cash-multiple" },
        { title: "Kartu", to: "/cashier/kartu", icon: "mdi-card-account-details" },
      ],
    };
  },
  methods: {
