...
export default {
  ...
  data() {
    return {
      ...
      //item di sidebar
      items: [
        { title: "Bahan", to: "/chef/bahan", icon: "mdi-food-steak" },
        { title: "Meja", to: "/chef/meja", icon: "mdi-table-furniture" },
        { title: "Pesanan", to: "/chef/pesanan", icon: "mdi-playlist-check" },
      ],
      riwayat: [
        { title: "Riwayat Masuk", to: "/riwayatMasuk", icon: "mdi-history" },
        {
